...
本系列文档是作者通过学习 `Vue.js` 源码和阅读 [《深入浅出Vue.js》](https://www.ituring.com.cn/book/2675) 时所记录的学习笔记。文档中的内容绝大部分是来自个人对源码的真实理解，另外，文档中有少部分图片以及文字摘自《深入浅出Vue.js》一书，此部分内容版权归原作者所有。本文档不涉及任何商业用途，仅提供个人学习和参考。
